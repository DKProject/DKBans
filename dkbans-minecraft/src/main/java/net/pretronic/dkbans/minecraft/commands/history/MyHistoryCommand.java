...
public class MyHistoryCommand extends BasicCommand implements Completable {

    public MyHistoryCommand(ObjectOwner owner, CommandConfiguration configuration) {
    ...
    public void execute(CommandSender sender, String[] arguments) {
        ...
        if(arguments.length > 0){
            ...
            if(arguments.length > 1){
                if(arguments[1].equalsIgnoreCase("changes")){
                ...
                }else if(!GeneralUtil.isNaturalNumber(arguments[1])){
                    sender.sendMessage(Messages.ERROR_INVALID_NUMBER,VariableSet.create()
                            .add("prefix",Messages.PREFIX));
                }else{
                    int snapshotId = Integer.parseInt(arguments[1]);
