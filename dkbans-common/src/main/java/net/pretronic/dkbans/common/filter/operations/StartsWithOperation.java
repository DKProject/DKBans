...
public class StartsWithOperation implements FilterOperation {

    private static final String NAME = "STARTS_WITH";

    private final String value;

    public StartsWithOperation(String value) {
    ...
    public static class Factory implements FilterOperationFactory {
        ...
        public FilterOperation build(String value) {
            return new StartsWithOperation(value);
        }
    }
}
